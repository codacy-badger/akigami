...
const routes = [
  ...
  },
  {
    ...
    action: async (ctx, params) => {
      ...
      return {
        title: response.data.getByUsername.displayName,
  ...
  },
  {
    ...
    action: async (ctx, params) => {
      ...
      return {
        title,
        component: await import(/* webpackChunkName: "explore" */ './pages/Explore'),
        params,
      };
    },
  },
  // закинуть в общий роут
  {
    ...
    action: async (ctx, params) => ({
      title: 'Добавить новое аниме',
      component: await import(/* webpackChunkName: "addAnimeEntity" */ './pages/AddAnimeEntity'),
      params: { type: 'create' },
    }),
  },
  // {
  ...
  //     }
  // return {
  //   title: response.data.anime.title.romaji,
  //   component: await import(/* webpackChunkName: "profile" */ './pages/User'),
  //   params,
  // };
  //   },
    ...
    children: [
      {
        ...
        action: async () => ({
          title: 'Студии',
          component: await import(/* webpackChunkName: "studios" */ './pages/Studios'),
        }),
      },
      {
        path: '/create',
        action: async () => ({
          ...
          component: await import(/* webpackChunkName: "addStudio" */ './pages/AddStudio'),
          params: { type: 'create' },
        }),
      },
      {
        ...
        children: [
          {
            ...
            action: async (ctx, params) => {
              ...
              return {
                title: response.data.studio.title,
                component: await import(/* webpackChunkName: "studio" */ './pages/Studio'),
                params,
              };
            },
          },
          {
            ...
            action: async (ctx, params) => {
              ...
              return {
                title: `Редактирование ${response.data.studio.title}`,
                component: await import(/* webpackChunkName: "addStudio" */ './pages/AddStudio'),
                params: { type: 'edit', ...params },
              };
            },
          },
        ],
  ...
  },
  {
    ...
    action: async (ctx, params) => {
      ...
      return {
        title: 'Регистрация',
        component: await import(/* webpackChunkName: "register" */ './pages/Register'),
        params: { email: response.data.getEmailFromToken, ...params },
      };
    },
  },
  {
    ...
    children: [
      {
        ...
        action: async (ctx, params) => ({
          title: 'Админ панель',
          component: await import(/* webpackChunkName: "admin" */ './pages/admin/Dashboard'),
          params: { activeTab: 'dashboard' },
        }),
      },
      {
        path: '/users',
        action: async (ctx, params) => ({
          ...
          component: await import(/* webpackChunkName: "admin:users" */ './pages/admin/Users'),
      ...
      },
      {
        ...
        action: async (ctx, params) => ({
          title: 'Список жанров',
          component: await import(/* webpackChunkName: "admin:genres" */ './pages/admin/Genres'),
          params: { activeTab: 'genres' },
        }),
      },
    ],
  },
